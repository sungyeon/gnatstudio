...
define $(PKG)_BUILD_$(HOST)
    ...
    GPR_PROJECT_PATH=$(SRC_DIR)/gnatcoll-bindings/iconv:$(SRC_DIR)/$($(PKG)_SUBDIR)/xref:$(SRC_DIR)/gnatcoll-db\sql && \
    GPR_PROJECT_PATH=$(GPR_PROJECT_PATH):$(SRC_DIR)/gnatcoll-db\sqlite &&   \
